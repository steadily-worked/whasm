use crate::{
    back_of_house::지원부서::{아침식사, 에피타이저},
    front_of_house::접객부서::호스팅::대기하기,
};
...
pub fn 레스토랑에서_식사하기() {
    ...
    // ex2) 레스토링에서_식사하기 함수를 서빙 모듈 내부로 옮겼을 경우, 상대 경로인 경우 수정해야함.
